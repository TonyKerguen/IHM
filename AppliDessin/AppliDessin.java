...
public class AppliDessin extends Application {
    ...
    */
    public void ajouteCercle(double centerX, double centerY){
        ...
        System.out.println(centerX+" "+centerY+" "+this.slider.getValue());
        if(0<centerX-this.slider.getValue() && 
           LARGEUR>centerX+this.slider.getValue() && 
           0<centerY-this.slider.getValue() && 
           HAUTEUR>centerY+this.slider.getValue()){
    ...
    public void augmenteLeDernierCercle(){
        ...
        if(c.getCenterX()+c.getRadius()+5<LARGEUR && 
           c.getCenterX()-c.getRadius()-5>0 &&
           c.getCenterY()+c.getRadius()+5<HAUTEUR && 
           c.getCenterY()-c.getRadius()-5>0){
     ...
     * Cette méthode change la couleur du dernier cercle dessiné
     */
    public void changeCouleurLeDernierCercle(Color cclr){
        Circle c = (Circle) this.boite.getChildren().get(this.boite.getChildren().size()-1);
        c.setFill(cclr);
    }
    ...
    private void ajouteCouleurs(BorderPane border){
        ...
        for (int i=0; i<couleurs.size(); i++){
            ...
            button.setOnAction(new ControleurCouleur(this, couleurs.get(i)));
